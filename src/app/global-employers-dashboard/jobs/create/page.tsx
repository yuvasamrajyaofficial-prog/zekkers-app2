...
export default function CreateGlobalJobPage() {
  ...
  const handleSubmit = () => {
    ...
    router.push('/global-employers-dashboard/jobs');
  };
      ...
      <Card>
        <CardHeader>
          <div className="flex items-center justify-between">
            <div>
              <CardTitle>Create a New Global Job</CardTitle>
              <CardDescription>
        ...
        <CardContent className="space-y-6">
          ...
          <div className="space-y-2">
            ...
            <Input
              ...
              placeholder="Comma-separated, e.g., Go, Kubernetes, AWS"
            />
          ...
          <div className="space-y-2">
            ...
            <Input
              ...
              placeholder="Comma-separated, e.g., M.Sc in CS"
            />
            <div className="flex flex-wrap gap-1 mt-2">
          ...
          <div className="flex justify-end gap-2">
            <Button
              variant="outline"
              onClick={() => router.push('/global-employers-dashboard/jobs')}
            >
              Cancel
            </Button>
        ...
        <DialogContent>
          ...
          <div className="space-y-4 py-4">
            ...
            <div className="space-y-2">
              ...
              <Input id="ai-keywords" value={aiKeywords} onChange={(e) => setAiKeywords(e.target.value)} placeholder="e.g., Django, FinTech, Berlin, 5+ years" />
            </div>
          </div>
          <DialogFooter>
