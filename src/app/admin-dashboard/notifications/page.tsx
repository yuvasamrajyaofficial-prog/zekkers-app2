...
export default function AdminNotificationsPage() {
    ...
    const send = async () => {
        // TODO: write to /notifications canonical collection in Firestore
        alert('Notification created (mock). In production: write to /notifications and Cloud Function will fanout.');
    };
                            ...
                            <Label htmlFor="audience">Audience</Label>
                             <Select value={audienceType} onValueChange={(v: any) => setAudienceType(v)}>
                                ...
                                <SelectContent>
                                    ...
                                    <SelectItem value="list">Specific users</SelectItem>
                                </SelectContent>
                            </Select>
                            {audienceType !== 'all' && (
                                <Input 
                                    placeholder="Filter (dept/batch/user-IDs...)" 
