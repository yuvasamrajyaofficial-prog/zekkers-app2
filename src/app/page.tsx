      ...
      <section className="relative min-h-[100svh] flex items-center justify-center px-6 md:px-12 pt-20 pb-16 overflow-hidden">
        ...
        <div className="absolute inset-0 overflow-hidden pointer-events-none z-10">
            ...
            <motion.div 
                ...
                className="absolute bottom-[15%] left-[2%] md:left-[5%] px-3 py-1.5 rounded-full bg-orange-500/20 border border-orange-400/50 text-orange-200 text-xs font-bold backdrop-blur-md hidden md:flex items-center gap-2 shadow-lg shadow-orange-500/20"
            >
            ...
            >
             ...
             <motion.div 
                ...
                className="absolute bottom-[5%] left-[20%] md:left-[25%] px-3 py-1.5 rounded-full bg-pink-500/20 border border-pink-400/50 text-pink-200 text-xs font-bold backdrop-blur-md hidden md:flex items-center gap-2 shadow-lg shadow-pink-500/20"
            >
