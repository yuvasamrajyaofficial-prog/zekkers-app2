      ...
      return (
        <Sheet open={openMobile} onOpenChange={setOpenMobile} {...props}>
          <SheetContent
            ...
            data-mobile="true"
            className="w-[--sidebar-width] bg-gray-100 p-0 text-white [&>button]:hidden fixed inset-y-0 left-0 z-50 shadow-2xl border-r border-gray-200"
            style={
              {
            ...
            side={side}
          >
            <div className="flex h-full w-full flex-col overflow-y-auto bg-gray-100">{children}</div>
          </SheetContent>
        </Sheet>
      )
    }
